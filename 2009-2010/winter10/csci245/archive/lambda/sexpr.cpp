...
Sexpr* Sexpr::eval_block(Environment* env)
{
	std::cout << "eval_block failed, received this-> ";
	this->print(std::cout);
	std::cout << endl;
	exit(2);
}

Sexpr* Sexpr::add_list(Environment* env)
{
...
Sexpr* Sexpr::subtract_list(Environment* env)
{
...
Sexpr* Sexpr::multiply_list(Environment* env)
{
	std::cout << "multiply_list failed, received this-> ";
	this->print(std::cout);
	std::cout << endl;
	exit(2);
}

Sexpr* Sexpr::apply(Sexpr* actualparameters)
{
	std::cout << "apply failed, received this-> ";
	this->print(std::cout);
	std::cout << endl;
	exit(2);
}
